...
public class BestsellersServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // In a real application, you would implement a method in BookDAO to get
            // bestsellers
            ...
            request.setAttribute("pageTitle", "Bestsellers");
            request.setAttribute("currentPage", "bestsellers");
            request.setAttribute("mainContent", "/views/pages/bestsellers.jsp");
