...
<head>
    ...
    <title>New Releases - Panna BookStore</title>
        ...
        <section class="featured-books">
            <div class="container">
                <div class="section-header">
                    <h2>Latest Books</h2>
                    <p>Be the first to read these new titles</p>
                ...
                <c:if test="${totalPages > 1}">
                    <div class="pagination">
                        <c:if test="${currentPage > 1}">
                            <a href="?page=${currentPage - 1}&sort=${sortBy}&category=${categoryFilter}" class="page-link"><i class="fas fa-chevron-left"></i></a>
                        </c:if>
                        ...
                        <c:if test="${currentPage < totalPages}">
                            <a href="?page=${currentPage + 1}&sort=${sortBy}&category=${categoryFilter}" class="page-link"><i class="fas fa-chevron-right"></i></a>
                        </c:if>
                    </div>
                </c:if>
            </div>
